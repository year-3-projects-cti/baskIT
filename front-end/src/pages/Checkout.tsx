...
const Checkout = () => {
  ...
  const { items, getTotals, placeOrder } = useCart();
  const { subtotal, shipping, vat, total } = getTotals(shippingMethod);
  ...
  const handlePlaceOrder = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!county) {
      toast.error("Selectează județul pentru livrare.");
      return;
    }

    const data = new FormData(event.currentTarget);
    const customerName = `${data.get("firstName") ?? ""} ${data.get("lastName") ?? ""}`.trim() || "Client BaskIT";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="glass-card rounded-2xl p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input id="firstName" name="firstName" placeholder="Prenumele tău" required />
                  </div>
                  <div>
                    <Label htmlFor="lastName">Nume *</Label>
                    <Input id="lastName" name="lastName" placeholder="Numele tău" required />
                  </div>
                  <div>
                    <Label htmlFor="email">Email *</Label>
                    <Input id="email" name="email" type="email" placeholder="exemplu@email.ro" required />
                  </div>
                  <div>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="md:col-span-2">
                      ...
                      <Input id="address" name="address" placeholder="Str. Exemplu, nr. 123, bl. A, sc. 1, et. 2, ap. 4" required />
                    </div>
                    <div>
                      <Label htmlFor="city">Oraș *</Label>
                      <Input id="city" name="city" placeholder="București" required />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <Input id="postalCode" name="postalCode" placeholder="012345" required />
                    </div>
                    <div>
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input id="companyName" name="companyName" placeholder="S.C. Exemplu S.R.L." />
                      </div>
                      <div>
                        <Label htmlFor="cui">CUI</Label>
                        <Input id="cui" name="cui" placeholder="RO12345678" />
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="glass-card rounded-2xl p-6">
                ...
                <div className="flex items-center space-x-2 mb-4">
                  <Checkbox id="terms" checked={agreeTerms} onCheckedChange={(value) => setAgreeTerms(Boolean(value))} />
            ...
            <div className="lg:col-span-1">
              <div className="glass-card rounded-2xl p-6 sticky top-24">
                ...
                <Button size="lg" type="submit" className="w-full shadow-strong mb-4" disabled={!items.length}>
